...
about this command. Read `docs/testing-stack.md` and follow it. If that file does not exist, or
...
6. COMMIT the tests you wrote.
   ...
   `test(<TICKET>): <text>` (`<serpens-sdd> git-naming` enforces the type), push to
