...
`@fresh-fx59/serpens-sdd` установлен, и `serpens-sdd version` печатает редакцию `2026-09-25.1`.
...
Slash-команды различаются от версии и профиля: измерено на профиле core OpenSpec 1.10.0 —
`propose, explore, apply, update, sync, archive`, а `new`, `continue` и `verify` нет вовсе;
текущее поддерживаемое окно — 1.11–1.13. Шесть вызовов CLI ниже стабильны и машиночитаемы. Запишите ОДИН токен — точный вызов
