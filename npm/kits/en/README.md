...
- submodule sync, repository-state gates, docs checks, and indexes: reached through the `<serpens-sdd>` token in commands and skills, backed by the `@fresh-fx59/serpens-sdd` package and the generated `tools/serpens-sdd` shim in each repository;
